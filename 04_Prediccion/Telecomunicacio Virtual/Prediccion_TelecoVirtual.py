...
print('Modelo - Telecomunicaciones Viirtual') # Para informar al usuario el modelo que esta corriendo


#----------------- Inicializacion -------------------------

#DataFrames
centroides=pd.read_excel("centroids10.xlsx",index_col=0) #DF con la los valores de los centroides
estu= pd.read_excel("EstudianteTelecoVirtual.xlsx",index_col=0) #DF con la informacion del estudiante
