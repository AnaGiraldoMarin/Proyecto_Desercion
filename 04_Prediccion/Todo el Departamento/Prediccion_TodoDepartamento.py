...
#DataFrames
centroides=pd.read_excel("centroids11.xlsx",index_col=0) #DF con la los valores de los centroides
estu= pd.read_excel("EstudianteTodo.xlsx",sheet_name="Valores",index_col=0) #DF con la informacion del estudiante
